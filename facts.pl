...
*/
availability(ai,        [slot(mon,1), slot(mon,2), slot(tue,1), slot(wed,2)]).
availability(math,      [slot(mon,3), slot(tue,2), slot(wed,1), slot(thu,1)]).
availability(physics,   [slot(mon,1), slot(tue,1), slot(thu,2), slot(fri,2)]).
availability(english,   [slot(wed,1), slot(thu,1), slot(fri,1)]).
availability(databases, [slot(mon,2), slot(tue,3), slot(wed,2), slot(fri,3)]).
...
room(lab1, 20, lab,       b2, 8).
room(lab2, 25, lab,       b2, 7).
...
*/
slot(mon, 1). slot(mon, 2). slot(mon, 3).
slot(tue, 1). slot(tue, 2). slot(tue, 3).
slot(wed, 1). slot(wed, 2). slot(wed, 3).
slot(thu, 1). slot(thu, 2). slot(thu, 3).
slot(fri, 1). slot(fri, 2). slot(fri, 3).
